...
import IconTitle from "assets/img/Title.png"
...
export default function OurCustomersSays() {
  ...
  return (
    <>
      <Container fluid  className="OurCustomersSays titleCustomers" >
        <h1 className='titleOurCustomers'>Our <span className='spanOurCustomers'>Customers Says</span></h1>
      </Container>
      <Container fluid  className="OurCustomersSays contentCustomers" >
              ...
              <div className='leftOurCustomers'>
                <Card className='flexleftOurCustomers'>
                  <InputGroup>
                    ...
                    <div className='iconTitle'><img src={IconTitle} alt="IconTitle" /></div>
                  </InputGroup>
